...
describe Game, type: :model do
  ...
  context 'Game Factory' do
    describe '.create_game_for_user!' do
      it 'corectly creates new game' do
  ...
  describe '.answer_current_question!' do
    context 'correct answer' do
      it 'continues the game correctly' do
        ...
        expect(game_w_questions.current_level).to eq(game_w_questions.previous_level + 1)
  ...
  context 'game mechanics' do
    it 'finishes the game correctly after take_money!' do
    ...
    describe '.previous_level' do
      it 'returns correct level' do
        game_w_questions.current_level = 11
        expect(game_w_questions.previous_level).to eq(10)
      end
    end
  end
end
